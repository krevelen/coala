/* $Id: WeightedComparable.java 323 2014-07-07 14:12:23Z krevelen $
 * $URL:
 ...
 * 
 * @param <C> the type of {@link WeightedCriterion} for this
 *        {@link WeightedComparable} type
 */
public interface WeightedComparable<C extends WeightedCriterion> extends
		Serializable
{

	/**
	 * @param criterion
	 * @return the value of this comparable for specified
	 *         {@link WeightedCriterion}
	 */
	Number getValue(C criterion);
