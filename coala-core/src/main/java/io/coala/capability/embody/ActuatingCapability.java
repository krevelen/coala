/* $Id: EmbodierService.java 296 2014-06-03 12:26:09Z krevelen $
...
/**
 * {@link ActuatingCapability} embodies an {@link Agent}s within some environment in
 ...
 */
public interface ActuatingCapability
		extends Capability<BasicCapabilityStatus>
{
	 ...
	 * @author <a href="mailto:Rick@almende.org">Rick</a>
	 */
	interface Factory extends CapabilityFactory<ActuatingCapability>
	{
		// empty
	}
