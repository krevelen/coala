/* $Id: EntityEmbodierService.java 299 2014-06-11 11:21:10Z krevelen $
...
/**
 * {@link GroundingCapability} embodies/grounds an {@link Agent}s within some
 ...
 * 
 * @param <THIS> the (sub)type of {@link GroundingCapability} to build
 */
public interface GroundingCapability extends Capability<BasicCapabilityStatus>
{
	 ...
	 * @author <a href="mailto:Rick@almende.org">Rick</a>
	 */
	interface Factory extends CapabilityFactory<GroundingCapability>
	{
