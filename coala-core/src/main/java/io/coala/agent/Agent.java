/* $Id: Agent.java 296 2014-06-03 12:26:09Z krevelen $
 ...
 * 
 * @param <THIS> the (sub)type of {@link Agent} to build
 */
public interface Agent extends
		Identifiable<AgentID>, LifeCycle<BasicAgentStatus>, Serializable
{

	/** @return the {@link Binder} currently binding this {@link Agent} */
	@JsonIgnore
	Binder getBinder();
