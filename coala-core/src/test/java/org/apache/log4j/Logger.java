...
public class Logger extends Category {
   ...
   * 
   *   @deprecated please use {@link LogUtil#getLogger(String)}
  */
  static
  public
  @Deprecated
   ...
   * for more detailed information.
    *   @deprecated please use {@link LogUtil#getLogger(Class)}
  */
  static
  public
  @Deprecated
  Logger getLogger(@SuppressWarnings("rawtypes") Class clazz) {
